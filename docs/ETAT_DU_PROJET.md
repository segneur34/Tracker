...
- Hors plan, le 25 septembre 2026 : planification d'itinéraires (point 59, APK 0.2.24) — page `/itineraires`, calcul BRouter en ligne, fiche et GPX dans `itineraires/`. Suite prévue : suivre un itinéraire pendant l'enregistrement (tracé sur la carte en direct, distance restante, puis alerte hors itinéraire) ; calcul hors ligne éventuel.
